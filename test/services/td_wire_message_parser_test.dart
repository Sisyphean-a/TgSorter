...
void main() {
  group('TD wire message parser', () {
    test(
      'parses text/photo/video/audio/document-video/unsupported messages',
      () {
        ...
        expect(
          dto.messages[4].content.localVideoThumbnailPath,
          '/tmp/d-thumb.jpg',
        );
    ...
    test('keeps file name and caption for non-video document messages', () {
      ...
      expect(
        dto.messages.single.content.kind,
        TdMessageContentKind.unsupported,
      );
